...
html_baseurl = 'https://iot.scylladb.com'
...
# Suppress warnings about unresolved cross-reference targets in README files.
# These READMEs contain relative links to code files and other READMEs that
# exist in the repository but are not part of the Sphinx source tree.
